...
namespace DeliveryService.DTOs
{
    ...
    public record CreateDeliveryDto(
        ...
        string City,
        string State,
        string Pincode,           // maps from OrderAPI's PostalCode
        string Country,           // ← ADD
        string ContactPhone,      // maps from OrderAPI's Phone
        string? ContactEmail,
    ...
    // ── OrderAPI integration DTOs ─────────────────────────────────────────
    // Mirrors OrderAPI's OrderResponseDto exactly
    ...
    public class OrderApiResponseDto
    {
        ...
        public OrderApiShippingAddressDto ShippingAddress { get; set; } = new();
        public List<OrderApiItemDto> Items { get; set; } = [];
    }

    public class OrderApiShippingAddressDto
    {
    ...
    // ── OrderAPI status update payload ────────────────────────────────────
