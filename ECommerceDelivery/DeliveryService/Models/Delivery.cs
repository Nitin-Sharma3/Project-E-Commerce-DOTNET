...
public class Delivery
{
    ...
    // Address — snapshot from OrderAPI.ShippingAddress
    ...
    [Required] public string Pincode { get; set; } = string.Empty;    // ← PostalCode from OrderAPI
    public string Country { get; set; } = "India";
    [Required] public string ContactPhone { get; set; } = string.Empty; // ← Phone from OrderAPI
